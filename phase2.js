...
function p2HeaderVectors(ctx,entry,values,project,layout=P2_LETTER){
  ...
  ctx.font=P2_LINK_FONT;p2WrapChars(ctx,values.link,L.frame.x+L.frame.w-14-dataX,2).forEach((line,i)=>items.push({text:line,x:dataX,y:137.5+i*9,size:7.8,font:P2_LINK_FONT}));return items;
}
